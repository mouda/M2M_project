close all
clear all
% function [totalLinearErrorSquare, totalEquationErrorSquare] = errorvsselectnum()
...
%             tmpErrorSquare = calculateLinearErrorSquare(recept, dep);
...
%             tmpErrorSauare = calculateEquationErrorSquare(recept, source, dep, expectUwind, Wdep, Wset, A, dt);
    ...
    num = num - 1;
    [totalLinearErrorSquare(num - selectedNum + 1), totalEquationErrorSquare(num - selectedNum + 1)] = calculateErrorSquare(recept, source, dep, expectUwind, Wdep, Wset, A, dt);
%     totalLinearErrorSquare(num - selectedNum + 1) = linearErrorSquare;
%     totalEquationErrorSquare(num - selectedNum + 1) = equationErrorSquare;
end

figure
plot(selectedNum:recept.n - 1, totalLinearErrorSquare);
xlabel('selectedNum');
ylabel('totalLinearErrorSquare');
figure
plot(selectedNum:recept.n - 1, totalEquationErrorSquare);
xlabel('selectedNum');
